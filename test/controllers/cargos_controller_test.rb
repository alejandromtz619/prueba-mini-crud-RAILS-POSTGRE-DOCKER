...
class CargosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cargo" do
    assert_difference('Cargo.count') do
      post cargos_url, params: { cargo: { descripcion: @cargo.descripcion, sueldo: @cargo.sueldo } }
    end
  ...
  test "should update cargo" do
    patch cargo_url(@cargo), params: { cargo: { descripcion: @cargo.descripcion, sueldo: @cargo.sueldo } }
