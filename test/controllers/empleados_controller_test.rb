...
class EmpleadosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create empleado" do
    assert_difference('Empleado.count') do
      post empleados_url, params: { empleado: { cargo_id: @empleado.cargo_id, ciudad_id: @empleado.ciudad_id, pais_id: @empleado.pais_id, persona_id: @empleado.persona_id, ubicacion_id: @empleado.ubicacion_id } }
    end
  ...
  test "should update empleado" do
    patch empleado_url(@empleado), params: { empleado: { cargo_id: @empleado.cargo_id, ciudad_id: @empleado.ciudad_id, pais_id: @empleado.pais_id, persona_id: @empleado.persona_id, ubicacion_id: @empleado.ubicacion_id } }
