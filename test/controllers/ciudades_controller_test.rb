...
class CiudadesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ciudade" do
    assert_difference('Ciudade.count') do
      post ciudades_url, params: { ciudade: { ciudad: @ciudade.ciudad, pais_id: @ciudade.pais_id } }
    end
  ...
  test "should update ciudade" do
    patch ciudade_url(@ciudade), params: { ciudade: { ciudad: @ciudade.ciudad, pais_id: @ciudade.pais_id } }
